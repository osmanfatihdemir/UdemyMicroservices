    ...
    public static class Config
    {
        ...
        public static IEnumerable<ApiScope> ApiScopes =>
            new ApiScope[]
            {
                ...
                new ApiScope("fake_payment_fullpermission","full access to FakePayment API"),
        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                ...
                new Client{
                    ...
                    AllowedScopes={"basket_fullpermission", "discount_fullpermission", "order_fullpermission", "fake_payment_fullpermission", IdentityServerConstants.StandardScopes.Email, IdentityServerConstants.StandardScopes.OpenId, 
