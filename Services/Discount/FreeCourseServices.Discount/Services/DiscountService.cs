...
namespace FreeCourseServices.Discount.Services
{
    public class DiscountService : IDiscountService
    {
        ...
        {
            var saveStatus = await _dbConnection.ExecuteAsync("update discount set userid=@UserId, code=@Code, rate=@Rate where id=@Id",
